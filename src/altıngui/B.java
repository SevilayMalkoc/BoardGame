...
public class B extends Oyuncu {

    public B(String oyuncuAdi, int adımSayısı, int toplamAdımSayısı, int harcananAltınMiktarı, int toplananAltınMiktarı) {
    ...
    public int[] adımSecim(Btn[][] board, char[][] altınIndex, int[][] gizliAltınIndex, int x, int y, int hamle, int hedefBelirleme) {
        ...
        if (yol[0] <= 3) {
            ...
            board[yol[1]][yol[2]].setBackground(Color.BLUE);
            board[yol[1]][yol[2]].setText("<html>" + board[yol[1]][yol[2]].getText() + "<br>" + "B" + "</html>");
